...
# https://github.com/thuml/Transfer-Learning-Library/tree/master/examples/domain_adaptation/image_classification/dan.py
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator, model: ImageClassifier,
    ...
    for i in range(args.iters_per_epoch):
        ...
        y_s, f_s = model(x_s)
        y_t, f_t = model(x_t)
        y_t_RMA, f_t_RMA = model(x_t_RMA)

        cls_loss = F.cross_entropy(y_s, labels_s)
        transfer_loss = mkmmd_loss(f_s, f_t)
        transfer_RMA_loss = mkmmd_loss(f_s, f_t_RMA)
