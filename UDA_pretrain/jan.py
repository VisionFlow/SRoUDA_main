...
# https://github.com/thuml/Transfer-Learning-Library/tree/master/examples/domain_adaptation/image_classification/jan.py
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator, model: ImageClassifier,
    ...
    for i in range(args.iters_per_epoch):
        ...
        transfer_RMA_loss = jmmd_loss(
            (f_s, F.softmax(y_s, dim=1)),
            (f_t_RMA, F.softmax(y_t_RMA, dim=1))
        )
